...
app.get("/robots.txt", function(req,res) {
    ...
    res.send(`User-agent: *\nAllow: /\nSitemap: https://gigantic-grey-knight.glitch.me/sitemap.xml`);
});

app.get("/sitemap.xml", function(req,res) {
    let link = "<url><loc>https://gigantic-grey-knight.glitch.me/</loc></url>";
    Object.values(db.get("bots")).forEach(bot => {
        link += "\n<url><loc>https://gigantic-grey-knight.glitch.me/bot/"+bot.id+"</loc></url>";
    })
